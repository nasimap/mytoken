...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'nasim' and abbreviation as 'nasi'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "nasim";
    string public tokenAbbrv = "nasi";
